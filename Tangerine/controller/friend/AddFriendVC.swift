...
class AddFriendVC: UIViewController, UISearchBarDelegate, MFMessageComposeViewControllerDelegate, UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    var tempDisplayedContacts = [Person]()
    ...
    func sortLocalList(){
        ...
        for person in self.displayedContacts{
        ...
        self.tempDisplayedContacts.removeAll()
        
        self.tempDisplayedContacts.append(contentsOf: registered)
        self.tempDisplayedContacts.append(contentsOf: requested)
        self.tempDisplayedContacts.append(contentsOf: others)
        
        self.displayedContacts.removeAll()
        self.displayedContacts = self.tempDisplayedContacts
    }
    ...
    /// When Add button is tapped, this ensures that we don't request the same person to be friends multiple times
